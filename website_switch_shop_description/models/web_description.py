...
class Products(models.Model):
    ...
    x_product_detail_uom_meter = fields.Selection([('MM', ' mm'), ('CM', ' cm'), ('M', ' m')],
                                                  default="CM", string="Afmeting")
    x_product_detail_uom_weight = fields.Selection([('G', ' g'), ('KG', ' kg')], default="G",
                                                   string="Gewicht type")
    x_product_detail_uom_weight_2 = fields.Selection([('G', ' g'), ('KG', ' kg')], default="G",
                                                     string="Draagvermogen type")
    x_product_detail_uom_liter = fields.Selection([('ML', ' ml'), ('CL', ' cl')], default="ML",
                                                  string="Inhoud type")
    x_product_detail_uom_m2 = fields.Selection([('CM', ' cm'), ('CM2', ' cm2'), ('M2', ' m2')],
    ...
    x_product_detail_dishwasher = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')],
                                                   string="Vaatwasser")
    x_product_detail_dishwashertemp = fields.Selection([('10', '10'), ('15', '15'), ('20', '20'),
                                                        ('25', '25'), ('30', '30'), ('35', '35'),
                                                        ('40', '40'), ('45', '45'), ('50', '50'),
                                                        ('55', '55'), ('60', '60'), ('65', '65'),
                                                        ('70', '70'), ('75', '75'), ('80', '80'),
                                                        ...
                                                        ('125', '125'), ('130', '130')],
                                                       string="Temperatuur")
    x_product_detail_freezer = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Vriezer")
    x_product_detail_freezertemp = fields.Integer("Temperatuur") 
    x_product_detail_microwave = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Magnetron")
    x_product_detail_microwavetemp = fields.Integer(string="Temperatuur")    
    x_product_detail_oven = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Oven")
    x_product_detail_oventemp = fields.Integer("Temperatuur")
    x_product_detail_washer = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Wasmachine")
    x_product_detail_washertemp = fields.Selection([('10', '10'), ('15', '15'), ('20', '20'),
                                                    ('25', '25'), ('30', '30'), ('35', '35'),
                                                    ('40', '40'), ('45', '45'), ('50', '50'),
                                                    ('55', '55'), ('60', '60'), ('65', '65'),
                                                    ('70', '70'), ('75', '75'), ('80', '80'),
    ...
    x_product_detail_foldable = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Opvouwbaar")
    x_product_detail_bendable = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Buigbaar")
    x_product_detail_mount = fields.Selection([('Schroeven', 'Schroeven'), ('Zuignappen', 'Zuignappen')],
                                              string="Bevestiging")
    x_product_detail_autoclaaf = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Autoclaaf")
    x_product_detail_autoclaaftemp = fields.Selection([('10', '10'), ('15', '15'), ('20', '20'),
                                                    ('25', '25'), ('30', '30'), ('35', '35'),
                                                    ('40', '40'), ('45', '45'), ('50', '50'),
                                                    ('55', '55'), ('60', '60'), ('65', '65'),
                                                    ('70', '70'), ('75', '75'), ('80', '80'),
                                                    ...
                                                    ('125', '125'), ('130', '130')],
                                                       string="Temperatuur")
    x_product_detail_lying_down = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Liggend")
    ...
    x_product_detail_package_inhoudpsm3 = fields.Float(string="Inhoud P/S in m3", compute="calculate_vol", digits=(15, 5))
    x_product_detail_package_length = fields.Float(string="Verpakking lengte", digits=(15, 0))
    x_product_detail_package_width = fields.Float("Verpakking breedte", digits=(15, 0))
    x_product_detail_package_height = fields.Float("Verpakking hoogte", digits=(15, 0))
    x_product_detail_package_inhoudps = fields.Float(string="Inhoud P/S", digits=(15, 0))
    x_product_detail_package_verzenddoos = fields.Many2one('product.template', string='Verzenddoos p/s', help="Verzenddoos per stuk")
    x_product_detail_package_benelux = fields.Selection([('Ja', 'Ja'), ('Nee', 'Nee')], string="Enveloppe Benelux")
    ...
    x_product_detail_package_type = fields.Selection([('bag', 'Bag'), ('box', 'Box'), ('card', 'Card'),
                                                      ('label', 'Label'), ('sleeve', 'Sleeve'), ('sticker', 'Sticker')],
                                                     string="Type")
    x_product_detail_package_stansmes = fields.Char("Stansmes")

    x_product_detail_carton_inhoudps = fields.Float(string="Omdoos: volume in m3", compute="calculate_carton", digits=(15, 5))
    x_product_detail_carton_length = fields.Float(string="Omdoos: lengte in mm", digits=(15, 0))
    x_product_detail_carton_width = fields.Float("Omdoos: breedte in mm", digits=(15, 0))
    x_product_detail_carton_height = fields.Float("Omdoos: hoogte in mm", digits=(15, 0))
    ...
    x_product_detail_width_adjust_uk = fields.Float(string="Verstelbare breedte uk", compute="width_adjust_calc_uk",
                                                    digits=(12, 2))
    x_product_detail_width_adjust_max_uk = fields.Float(string="Verstelbare breedte max uk",
                                                        compute="width_adjust_calc_max_uk", digits=(12, 2))
    x_product_detail_height_adjust_uk = fields.Float(string="Verstelbare hoogte uk",
                                                     compute="height_adjust_calc_uk", digits=(12, 2))
    x_product_detail_height_adjust_max_uk = fields.Float(string="Verstelbare hoogte max uk",
                                                         compute="height_adjust_calc_max_uk", digits=(12, 2))
    x_product_detail_diameter_inner_uk = fields.Float(string="Binnen diameter uk",
    ...
    x_product_detail_nl_product_name = fields.Char(string="NL Product name")
    x_product_detail_nl_short_description = fields.Char(string="NL Short description")
    x_product_detail_nl_long_description = fields.Char(string="NL Long description")
    x_product_detail_nl_ubr_1 = fields.Char(string="NL UBR 1")
    x_product_detail_nl_color = fields.Char(string="NL Color")

    x_product_detail_en_product_name = fields.Char(string="EN Product name")
    x_product_detail_en_short_description = fields.Char(string="EN Short description")
    x_product_detail_en_long_description = fields.Char(string="EN Long description")
    x_product_detail_en_ubr_1 = fields.Char(string="EN UBR 1")
    x_product_detail_en_color = fields.Char(string="EN Color")

    x_product_detail_fr_product_name = fields.Char(string="FR Product name")
    x_product_detail_fr_short_description = fields.Char(string="FR Short description")
    x_product_detail_fr_long_description = fields.Char(string="FR Long description")
    x_product_detail_fr_ubr_1 = fields.Char(string="FR UBR 1")
    x_product_detail_fr_color = fields.Char(string="FR Color")

    x_product_detail_de_product_name = fields.Char(string="DE Product name")
    x_product_detail_de_short_description = fields.Char(string="DE Short description")
    x_product_detail_de_long_description = fields.Char(string="DE Long description")
    x_product_detail_de_ubr_1 = fields.Char(string="DE UBR 1")
    x_product_detail_de_color = fields.Char(string="DE Color")

    x_product_detail_es_product_name = fields.Char(string="ES Product name")
    x_product_detail_es_short_description = fields.Char(string="ES Short description")
    x_product_detail_es_long_description = fields.Char(string="ES Long description")
    x_product_detail_es_ubr_1 = fields.Char(string="ES UBR 1")
    x_product_detail_es_color = fields.Char(string="ES Color")

    x_product_detail_it_product_name = fields.Char(string="IT Product name")
    x_product_detail_it_short_description = fields.Char(string="IT Short description")
    x_product_detail_it_long_description = fields.Char(string="IT Long description")
    x_product_detail_it_ubr_1 = fields.Char(string="IT UBR 1")
    x_product_detail_it_color = fields.Char(string="IT Color")

    x_product_detail_dk_product_name = fields.Char(string="DK Product name")
    x_product_detail_dk_description = fields.Char(string="DK description")
    x_product_detail_dk_color = fields.Char(string="DK color")
    x_product_detail_ee_product_name = fields.Char(string="EE Product name")
    x_product_detail_ee_description = fields.Char(string="EE description")
    x_product_detail_ee_color = fields.Char(string="EE color")
    x_product_detail_fi_product_name = fields.Char(string="FI Product name")
    x_product_detail_fi_description = fields.Char(string="FI description")
    x_product_detail_fi_color = fields.Char(string="FI color")
    x_product_detail_lt_product_name = fields.Char(string="LT Product name")
    x_product_detail_lt_description = fields.Char(string="LT description")
    x_product_detail_lt_color = fields.Char(string="LT color")
    x_product_detail_lv_product_name = fields.Char(string="LV Product name")
    x_product_detail_lv_description = fields.Char(string="LV description")
    x_product_detail_lv_color = fields.Char(string="LV color")
    x_product_detail_no_product_name = fields.Char(string="NO Product name")
    x_product_detail_no_description = fields.Char(string="NO description")
    x_product_detail_no_color = fields.Char(string="NO color")
    x_product_detail_pt_product_name = fields.Char(string="PT Product name")
    x_product_detail_pt_description = fields.Char(string="PT description")
    x_product_detail_pt_color = fields.Char(string="PT color")
    x_product_detail_ru_product_name = fields.Char(string="RU Product name")
    x_product_detail_ru_description = fields.Char(string="RU description")
    x_product_detail_ru_color = fields.Char(string="RU color")
    x_product_detail_si_product_name = fields.Char(string="SI Product name")
    x_product_detail_si_description = fields.Char(string="SI description")
    x_product_detail_si_color = fields.Char(string="SI color")
    x_product_detail_se_product_name = fields.Char(string="SE Product name")
    x_product_detail_se_description = fields.Char(string="SE description")
    x_product_detail_se_color = fields.Char(string="SE color")

    @api.onchange('x_product_detail_package_length', 'x_product_detail_package_width',
                  'object.x_product_detail_package_height')
    def calculate_vol(self):
        for object in self:
            object.x_product_detail_package_inhoudpsm3 = 0
            object.x_product_detail_package_inhoudpsm3 = object.x_product_detail_package_length *\
                                                       object.x_product_detail_package_width *\
                                                       object.x_product_detail_package_height / 1000000000

    @api.onchange('x_product_detail_carton_length', 'x_product_detail_carton_width',
