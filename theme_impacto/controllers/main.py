...
class show_webpage(http.Controller): 
#Add custom login for business
     @http.route(['/web/login_business'], type='http', auth='public', website=True)
     def show_custom_webpage(self, **kw):
          return http.request.render('theme_impacto.login_business')
        ...
        if search:
            for srch in search.split(" "):
                domain += [
                    ...
                    ('bam_product_keyword1', 'ilike', srch), ('bam_product_keyword2', 'ilike', srch), ('bam_product_keyword3', 'ilike', srch),
                    ('bam_product_keyword4', 'ilike', srch), ('bam_product_keyword5', 'ilike', srch)]
