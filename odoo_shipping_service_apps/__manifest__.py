...
#################################################################################
{
  ...
  "description"          :  """FedEx ,USPS,UPS,DHL,Australia Post and Aramex Shipping API Integration as Odoo Delivery Method .
    Provide Shipping Label Generation and Shipping Rate Calculator For Website as Well Odoo BackEnd.""",
  "live_test_url"        :  "http://odoodemo.webkul.com/?module=odoo_shipping_service_apps&version=10.0",
  "depends"              :  [
                             'product',
                             'wk_wizard_messages',
                             'delivery',
